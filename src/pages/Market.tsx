        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="relative bg-[#050b18] border-2 border-blue-500 shadow-[0_0_30px_rgba(59,130,246,0.4)] p-6 max-w-sm w-full font-mono">
            <div className="text-center space-y-4">
              ...
              <button onClick={() => setIsScanning(false)} className="text-[10px] text-blue-500 border border-blue-500/30 px-4 py-1">إغلاق</button>
            </div>
          </div>
        </div>
      )}
        ...
        {SOLO_ITEMS.map((item) => {
          ...
          return (
            <div key={item.id} className="relative group transition-all active:scale-[0.98]">
              <div className="relative bg-black/60 border-2 border-slate-200/90 p-4 shadow-[0_0_20px_rgba(30,58,138,0.3)] transition-all group-active:border-blue-500">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    <div className="w-24 h-24 border border-slate-500/50 flex items-center justify-center bg-black/40 relative flex-shrink-0">
                      <span className="text-4xl filter grayscale brightness-200 opacity-40 drop-shadow-[0_0_10px_rgba(255,255,255,0.4)]">
                        {item.icon}
                      </span>
                    </div>
