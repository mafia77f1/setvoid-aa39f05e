  ...
  return (
    <div className="min-h-screen bg-[#020817] text-white p-3 font-sans selection:bg-blue-500/30 pb-24">
      ...
      <header className="relative z-10 flex justify-between items-center mb-6 border-b border-blue-500/30 pb-3">
        <h1 className="text-xl font-bold tracking-[0.1em] uppercase italic text-blue-400 drop-shadow-[0_0_8px_rgba(255,255,255,0.6)]">
          Player Status
        </h1>
        <div className="bg-blue-950/40 border border-blue-400/50 px-3 py-1 flex items-center gap-2">
          <Coins className="w-3.5 h-3.5 text-yellow-400" />
          <span className="font-mono font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] text-sm">
          ...
          {['stats', 'equipment'].map((tab) => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab 
                  ? "bg-blue-500/20 border-blue-400 text-white shadow-[0_0_15px_rgba(255,255,255,0.3)]" 
              ...
              <div className="flex justify-center mb-6 mt-[-2.5rem]">
                <div className="border border-slate-400/50 px-6 py-1 bg-slate-900/90 shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                  <h2 className="text-xs font-bold tracking-widest text-white drop-shadow-[0_0_12px_rgba(255,255,255,0.9)] uppercase italic">
                    Class: <span className="text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.7)]">Shadow Monarch</span>
                  </h2>
                </div>
              </div>
                ...
                <div key={stat.category} className="bg-black/60 border border-slate-700/50 p-3">
                  <div className="flex justify-between items-end mb-2">
                    <div className="flex items-center gap-3">
                      <div className="text-white opacity-80 drop-shadow-[0_0_5px_rgba(255,255,255,0.5)]">{stat.icon}</div>
                      <span className="text-xs font-bold tracking-tighter text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.4)] uppercase">{stat.name}</span>
                    </div>
                    <span className="text-lg font-black italic text-white drop-shadow-[0_0_12px_rgba(255,255,255,0.8)]">
                      {stat.level}
                    </span>
                  </div>
