...
import { User, Dumbbell, Brain, Heart, Zap, Shield, Menu, Copy, LogOut, Fingerprint, Activity } from 'lucide-react';
    ...
    <div className="h-screen w-full bg-[#f0f2f5] overflow-hidden flex flex-col font-sans">
      ...
      <main className="flex-1 flex items-center justify-center p-4 relative z-10">
        <div className={cn(
          ...
          {/* DECORATIVE FOOTER */}
          <div className="mt-4 pt-4 border-t border-slate-100 flex justify-between items-center opacity-40">
             <div className="text-[7px] font-mono font-bold uppercase tracking-tighter">Authorized by Hunter Assoc.</div>
